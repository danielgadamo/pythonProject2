...
# worker1=Worker("yoni","mosbi", 1980, 3, 2, "jerusalem","israel")
# worker2=Worker("dani","mosbi", 1985, 3, 2, "jerusalem","israel")
# print(worker1.greet(worker2))
# print(worker2.first_name)
# print(worker1.age())
# print(worker1.full_name())
# print(worker1.days_to_birthday())